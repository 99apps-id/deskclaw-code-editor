...
export const APP_NAME = 'DeskClaw Code Editor'

/** electron-builder / Windows AUMID */
export const APP_ID = 'com.deskclaw.code-editor'

/** Pre-rename AppData folder — migrate shell config once when present */
export const APP_NAME_LEGACY = 'DeskClaw Code Editor'
